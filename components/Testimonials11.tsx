                ...
                <figcaption className='relative flex items-center justify-start gap-4 pt-4 mt-4 border-t border-base-content/5'>
                    ...
                    <div className='w-full flex items-end justify-between gap-2'>
                        <div>
                            ...
                            {testimonial.username && <div className='mt-0.5 text-sm text-base-content/80'>@{testimonial.username}</div>}
                        </div>
...
const VideoTestimonial = ({ i }: { i: number }) => {
    ...
    return (
        <li key={i} className='break-inside-avoid max-md:flex justify-center bg-base-100 rounded-lg overflow-hidden flex flex-col'>
            <div className='relative w-full'>
                ...
                {!isPlaying && <div className='absolute bottom-0 -inset-x-4 bg-gray-900/50 blur-lg h-24 translate-y-1/4 animate-opacity'></div>}

                <div className='absolute w-full bottom-0 z-20'>
                    <div className='flex justify-between items-end p-4'>
                        <button className='group cursor-pointer' type='button' title='Play video' aria-label='Play video' onClick={handlePlayVideo}>
                            {isPlaying ? (
                                // PAUSE
                                <svg
        ...
        <section className='bg-base-200' id='testimonials'>
            <div className='py-24 px-8 max-w-7xl mx-auto'>
                <div className='flex flex-col text-center w-full mb-20'>
                    <div className='mb-8'>
                        <h2 className='sm:text-5xl text-4xl font-extrabold text-base-content'>212 makers are already shipping faster!</h2>
                    </div>
