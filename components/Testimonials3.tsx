...
const Testimonials3 = (testimonials: TestimonialSectionProps) => {
    return (
        <section className='py-14'>
            <div className='max-w-screen-xl mx-auto px-4 text-center md:px-8'>
                <span className='inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-full'>
                    TÉMOIGNAGES
                </span>
                <div className='max-w-2xl mx-auto'>
                    <h2 className='mb-4 font-extrabold text-4xl lg:text-6xl tracking-tight text-primary'>{testimonials.sectionTitle}</h2>
                    <h3 className='mb-16 xl:mb-24 mx-auto text-lg md:text-xl text-gray-400 font-medium max-w-4xl'>{testimonials.sectionSubtitle}</h3>
                </div>
                <div className='mt-12 mb-16 xl:mb-24'>
                        ...
                        {testimonials.testimonials.map((item, idx) => (
                            <li key={idx} className={`bg-white rounded-xl border shadow-md`}>
                                ...
                                <figure>
                                    ...
                                    <div className='flex items-center gap-x-4 p-4 mt-6 bg-secondary20'>
                                        <Image
                                            src={item.avatar}
                                            className='rounded-full border-2 border-primary80'
                                            alt='Avatar'
                                            width={64}
                                            height={64}
                                        />
