...
import { articleType, loadArticles } from '@/libs/articles';
...
export async function generateMetadata({ params }: { params: { locale: string; categoryId: string; subcategoryId: string; articleId: string } }) {
...
export default async function Article({ params }: { params: { categoryId: string; subcategoryId: string; articleId: string } }) {
            ...
            <article>
                ...
                <div className='flex flex-col md:flex-row'>
                    ...
                    <section className='max-md:pb-4 md:pl-12 max-md:border-b md:border-l md:order-last md:w-72 shrink-0 border-base-content/10'>
                        <p className='text-base-content/80 text-sm mb-2 md:mb-3'>Posté par</p>
                        <Avatar article={article} />

                        {articlesRelated.length > 0 && (
                            <div className='hidden md:block mt-12'>
                                <p className=' text-base-content/80 text-sm  mb-2 md:mb-3'>Lectures recommandées</p>
