...
import alexImg from '@/public/images/blog/authors/alex.png';
...
export const articles: articleType[] = [
            ...
            <>
                ...
                <section>
                    ...
                    <p className={styles.p}>
                        Supabase is an open-source Firebase alternative. It&apos;s a great tool for building a backend for your app. It&apos;s now
                        integrated with ShipFast!
                    </p>
                </section>
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
                ...
                <section>
                    ...
                    <p className={styles.p}>
                        Copy the <span className={styles.codeInline}>API URL</span> and <span className={styles.codeInline}>API Key</span> from your
                        Supabase project settings and add them to your ShipFast project settings. Add these files to your project:
                    </p>
