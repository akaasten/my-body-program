...
import { categoryType } from '@/libs/articles';
...
const links: {
    ...
    {
        href: '/blog/',
        label: 'header_all_articles',
    },
];

const ButtonPopoverCategories = ({ categories }: { categories: categoryType[] }) => {
...
const ButtonAccordionCategories = ({ categories }: { categories: categoryType[] }) => {
...
const HeaderBlog = ({ categories }: { categories: categoryType[] }) => {
